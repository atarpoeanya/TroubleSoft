                    ...
                    <div class="row d-flex justify-content-evenly text-nowrap">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" type="date" name="購入日_edit" id="purchaseDate_edit" value="<?=$spare->c_purchaseDate ?>">
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" type="text" name="使用箇所_edit" id="placement_edit" value="<?=$spare->c_placement ?>">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" type="text" name="部品名_edit" id="partName_edit" value="<?=$spare->c_partName ?>">
                            </div>
                            <div class="col">
                                <label class="form-label" for="model">型式</label>
                                <input class="form-control" type="text" name="型式_edit" id="model_edit" value="<?=$spare->c_model?>">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" type="text" name="メーカー名_edit" id="maker_edit" value="<?=$spare->c_maker?>">
                            </div>
                            <div class="col">
                                <label class="form-label" for="quantity">数量</label>
                                <input class="form-control" type="text" name="数量_edit" id="quantity_edit" value="<?=$spare->c_quantity?>" >
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" type="text" name="金額_edit" id="price_edit" value="<?=$spare->c_price?>">
                            </div>
                            <div class="col">
                                <label class="form-label" for="unit">単位</label>
                                <input class="form-control" type="text" name="単位_edit" id="unit_edit" value="<?=$spare->c_unit?>">
                            </div>
                        </div>
                    </div>
                </form>
