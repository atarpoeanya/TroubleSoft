                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col pt-3">
                                    ...
                                    <span class="must form-check-label">必須</span>
                                    <input class="form-control" type="number" name="数量_edit" id="quantity_edit" value="<?= $spare->c_quantity ?>" required>
                                </div>
                                <div class="col pt-3">
                                ...
                                <div class="col pt-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" name="金額_edit" id="price_edit" value="<?= $spare->c_price ?>" required>
                                    </div>
                                </div>
                            </div>
                            <br>
